        ...
        with Horizontal(id="layout"):
            ...
            with Vertical(id="channels-pane"):
                with Horizontal(id="channel-tabs"):
                    yield Button("Channels", id="tab-channels", variant="primary")
                    yield Button("Favorites", id="tab-favorites")
                yield Input(placeholder="Search channels…", id="search")
                yield ListView(id="channel-list")
                with Horizontal(id="channel-actions"):
                    yield Button("Play", id="channel-play", variant="success")
                    yield Button("Stop", id="channel-stop", variant="warning")
                    yield Button("Toggle Favorite", id="channel-favorite")
